...
DECLARE_COMPONENT_VERSION("Adlib OPL Decoder", "1.1",
	"Adlib OPL music decoder\n"
	"Based on AdPlug, customized a little");


// This will prevent users from renaming your component around (important for proper troubleshooter behaviors) or loading multiple instances of it.
VALIDATE_COMPONENT_FILENAME("foo_input_adlib_opl.dll");
